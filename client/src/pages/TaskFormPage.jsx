...
export function TaskFormPage(){
    ...
    const onSubmit = handleSubmit(async data => {
        if (params.id){
            ...
            toast.success('Task Updated', {position: 'top-right', style:{
                background: "#101010",
                color: "#fff"
            }})
        }else {
            await createTask(data)
            toast.success('Task Created', {position: 'top-right', style:{
                background: "#101010",
                color: "#fff"
            }})
        }
        ...
        <div className='max-w-xl mx-auto'>
            ...
            <div className='flex justify-end'>
                ...
                if (accepted){
                    ...
                    toast.success('Task Deleted', {position: 'top-right', style:{
                        background: "#101010",
                        color: "#fff"
                    }})
                    navigate('/tasks')
